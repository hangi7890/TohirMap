...
export const cultureData = [
  ...
  },
  {
    ...
    img: '/images/food.jpg',
    title: '🍽️ 전통 음식 문화',
    desc: '우즈베키스탄의 식탁은 플로브, 논, 녹차처럼 함께 나누어 먹는 음식으로 따뜻한 공동체 문화를 보여줍니다.',
    location: '타슈켄트 초르수 바자르, 사마르칸트 전통 식당',
    point: '플로브를 중심으로 전통 빵, 샐러드, 차를 함께 즐기는 식사 방식',
    tip: '큰 접시에 나온 음식을 함께 나누는 분위기를 자연스럽게 즐겨보세요'
  },
  {
    id: 'history',
    img: '/images/history.jpg',
    title: '🏛️ 역사 유산',
    desc: '사마르칸트, 부하라, 히바는 실크로드의 흔적과 이슬람 건축미가 살아 있는 우즈베키스탄 대표 역사 도시입니다.',
    location: '사마르칸트 레기스탄, 부하라 구시가지, 히바 이찬칼라',
    point: '푸른 타일 건축, 고대 성벽, 실크로드 교역 도시의 흔적',
    tip: '낮에는 건축 디테일을 보고, 저녁에는 조명이 켜진 광장을 함께 보는 걸 추천합니다'
  }
];
